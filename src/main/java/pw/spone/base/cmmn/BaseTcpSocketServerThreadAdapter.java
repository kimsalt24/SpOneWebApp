...
public class BaseTcpSocketServerThreadAdapter extends TcpSocketServerThreadAdapter {
 	 
	InputStream inputStream = null;
	OutputStream outputStream = null; 
	
	private String DATA_ENC = "EUC-KR";
	private String CONTEXT_PATH_URL = PropUtil.getMessage("EL_HTTP_CONTEXT_PATH_BASE_URL"); // "http://localhost:9002/SpOneWebApp/";
	final private int DATA_LEN_FIELD_LEN = 10; // 전문길이 필드 길이
	final private int READ_DATA_LEN = 1024; // 힌번에 읽을 길이 

	public BaseTcpSocketServerThreadAdapter(Socket s){
        super(s);
    }

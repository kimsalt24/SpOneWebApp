...
/**  
 * @Class Name : BaseSessionDataAdapter.java
 ...
 */
public class BaseSessionDataAdapter extends SessionDataAdapter {
	/**
	 * SessionAdapter 생성자이다.
	 * 
	 * @param adapterInfoMap Adapter 정보
	 */
	public BaseSessionDataAdapter(Map<String, Object> adapterInfoMap) {
	 ...
	 * @return BaseUserHeader
	 * @throws AdapterException
	 */
	@Override
	public BaseUserHeader setSessionData(HttpServletRequest request, String id, Object... obj) throws AdapterException{

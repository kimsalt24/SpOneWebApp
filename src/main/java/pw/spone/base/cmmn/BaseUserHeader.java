...
public class BaseUserHeader extends com.inswave.elfw.core.UserHeader {
    private static final long serialVersionUID = 1L;

    private int _offset;

    public BaseUserHeader(){
        this._offset = 0;
    }

    public BaseUserHeader(int iOffset){
    ...
    private java.util.List<pw.spone.base.cmmn.Test01UserHeader> test01UserHeader;
    ...
    private java.util.List<pw.spone.base.cmmn.Test02UserHeader> test02UserHeader;
    ...
    public java.util.List<pw.spone.base.cmmn.Test01UserHeader> getTest01UserHeader(){
        return test01UserHeader;
    }

    public void setTest01UserHeader(java.util.List<pw.spone.base.cmmn.Test01UserHeader> test01UserHeader){
        this.test01UserHeader = test01UserHeader;
    }

    public java.util.List<pw.spone.base.cmmn.Test02UserHeader> getTest02UserHeader(){
        return test02UserHeader;
    }

    public void setTest02UserHeader(java.util.List<pw.spone.base.cmmn.Test02UserHeader> test02UserHeader){
    ...
    public void _xStreamEnc() {
        for( int i=0 ; test01UserHeader != null && i < test01UserHeader.size() ; i++ ) {
            pw.spone.base.cmmn.Test01UserHeader vo = (pw.spone.base.cmmn.Test01UserHeader)test01UserHeader.get(i);
            vo._xStreamEnc();	 
        }
        for( int i=0 ; test02UserHeader != null && i < test02UserHeader.size() ; i++ ) {
            pw.spone.base.cmmn.Test02UserHeader vo = (pw.spone.base.cmmn.Test02UserHeader)test02UserHeader.get(i);
            vo._xStreamEnc();	 
        }
    }

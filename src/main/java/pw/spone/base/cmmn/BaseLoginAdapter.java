 ...
 * 
 */
public class BaseLoginAdapter extends LoginAdapter {
	 ...
	 */
	public BaseLoginAdapter(Map<String, Object> adapterInfoMap){
	...
	public LoginInfo login(HttpServletRequest request, String id, Object... params) throws LoginException {
		...
		info.setSuc(true);
		AppLog.debug("[Login] Base Login 성공.....");
	...
	public LoginInfo logout(HttpServletRequest request, String id, Object... params) throws LoginException {
		...
		try{			
			...
			// 2. 로그아웃 성공 설정 
			info.setSuc(true);
			AppLog.debug("[Logout] Base Logout 성공.....");

...
public class EmpListVo extends pw.spone.base.cmmn.BaseCommVO {
    ...
    private java.util.List<pw.spone.base.emp.vo.EmpVo> empVoList;
    ...
    private pw.spone.base.emp.vo.EmpVo empVo;

    public int getEmpCnt(){
        return empVoList != null ? empVoList.size() : 0 ;
    }

    public java.util.List<pw.spone.base.emp.vo.EmpVo> getEmpVoList(){
        return empVoList;
    }

    public void setEmpVoList(java.util.List<pw.spone.base.emp.vo.EmpVo> empVoList){
    ...
    public pw.spone.base.emp.vo.EmpVo getEmpVo(){
        return empVo;
    }

    public void setEmpVo(pw.spone.base.emp.vo.EmpVo empVo){
        this.empVo = empVo;
    }
	...
	public byte[] marshalFld(String encode) throws Exception{
        ...
        try {
            ...
            for( int i=0 ; empVoList != null && i < empVoList.size() ; i++ ) {
                pw.spone.base.emp.vo.EmpVo vo = (pw.spone.base.emp.vo.EmpVo)empVoList.get(i);
    ...
    public void unMarshalFld( byte[] bytes , String encode) throws Exception{
        try{ 
             ...
             {
                 java.util.List<pw.spone.base.emp.vo.EmpVo> alList = new java.util.ArrayList<pw.spone.base.emp.vo.EmpVo>();
                 for( int i=0 ; i < empCnt ; i++ ) {
                     pw.spone.base.emp.vo.EmpVo vo = new pw.spone.base.emp.vo.EmpVo(_offset);
    ...
    public void _xStreamEnc() {
        ...
        for( int i=0 ; deptVoList != null && i < deptVoList.size() ; i++ ) {
            pw.spone.base.emp.vo.DeptVo vo = (pw.spone.base.emp.vo.DeptVo)deptVoList.get(i);
            vo._xStreamEnc();	 
        }

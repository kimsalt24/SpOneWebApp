...
import pw.spone.base.cmmn.BaseUserHeader;
import pw.spone.base.cmmn.tcp.BaseTcpLengthBaseSendUtil;
import pw.spone.base.emp.service.EmpFileService;
import pw.spone.base.emp.service.EmpService;
import pw.spone.base.emp.vo.DeptListVo;
import pw.spone.base.emp.vo.EmpListVo;
...
public class EmpController {
    ...
    public void login(pw.spone.base.emp.vo.LoginVo loginVo, HttpServletRequest request) throws Exception {
    ...
    public void loginFrm(pw.spone.base.emp.vo.LoginVo loginVo, HttpServletRequest request) throws Exception {    
		String id = loginVo.getId();
	...
	public EmpVo tcpSendTest(EmpVo empVo) throws Exception {
		...
		BaseUserHeader userHeader = new BaseUserHeader();
		userHeader.setSvcId("DmoEmpSelect");
		userHeader.setTestId("TEST_ID");
		
		ElResDataVO resVo = BaseTcpLengthBaseSendUtil.sendFld("localhost", 9999, userHeader, eInVo, eOutVo, 10, false, "EUC-KR");
		
		EmpVo resEmpVo = (EmpVo) resVo.getVo();
		BaseUserHeader resUserHeader =(BaseUserHeader) resVo.getUserHeader();

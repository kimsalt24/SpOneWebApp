...
public class EmpFileDAO extends BaseDefaultAbstractDAO {
    ...
    public int insertEmpFile(EmpVo empVo) throws ElException {    	
        return insert("pw.spone.base.emp.insertEmpFile", empVo);
    }
    ...
    public int updateEmpFile(EmpVo empVo) throws ElException {
        return update("pw.spone.base.emp.updateEmpFile", empVo);
    }
    ...
    public int deleteEmpFile(EmpVo empVo) throws ElException {
        return delete("pw.spone.base.emp.deleteEmpFile", empVo);
    }
    ...
    public EmpVo selectEmpFile(EmpVo empVo) throws ElException {
        return (EmpVo) selectByPk("pw.spone.base.emp.selectEmpFile", empVo);
    }
